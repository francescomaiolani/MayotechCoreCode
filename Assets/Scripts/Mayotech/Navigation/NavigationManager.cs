...
public class NavigationManager : SingletonPersistent<NavigationManager>, IService
{
    [SerializeField] private int navigationRequestLimit = 2;
    [SerializeField] private SceneConfig[] preloadScenes;
    [SerializeField] private SceneConfig[] allScenes;
    [SerializeField] private OnSceneLoadedGameEvent onSceneLoadedGameEvent;
    [SerializeField] private OnNavigationStartedGameEvent onNavigationStarted;
    [SerializeField] private OnNavigationEndedGameEvent onNavigationEnded;
    ...
    public UniTask PreloadScenes()
    {
        var operations = preloadScenes
            .Select(scene => SceneManager.LoadSceneAsync(scene.SceneName, LoadSceneMode.Additive).ToUniTask()).ToList();
