...
public class ServiceLocator : SingletonPersistent<ServiceLocator>
{
    ...
    [Header("Services")] [SerializeField, AutoConnect] protected NavigationManager navigationManager;
    ...
    [SerializeField, AutoConnect] protected SFXManager sfxManager;
    ...
    [Header("Unity Events")] [SerializeField] protected GameEvent<bool> onApplicationPause;
